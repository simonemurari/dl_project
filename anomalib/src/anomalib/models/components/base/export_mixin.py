...
class ExportMixin:
    ...
    def to_openvino(
        ...
        # Added ignore_cleanup_errors to avoid errors when the temporary directory is deleted.
        with TemporaryDirectory(ignore_cleanup_errors=True) as onnx_directory:
